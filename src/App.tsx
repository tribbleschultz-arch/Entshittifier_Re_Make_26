            ...
            >
              ...
              <div className="flex-1 flex flex-col items-center justify-start w-full px-6">
                ...
                <div className="relative w-full max-w-[320px] shrink-0 mt-8 mb-4">
                  ...
                  <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[9px] font-bold text-natural-primary uppercase tracking-[0.1em] whitespace-nowrap z-10 w-full text-center">
                    Gesellschaftliches Bedürfnis <span className="opacity-50">↑</span>
                  </div>
                  
                  <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-[9px] font-bold text-natural-primary uppercase tracking-[0.1em] whitespace-nowrap z-10 w-full text-center">
                    Individualbedürfnis <span className="opacity-50">↓</span>
                  </div>

                  <div className="absolute top-1/2 right-[-24px] -translate-y-1/2 translate-x-1/2 rotate-90 text-[9px] font-bold text-natural-primary uppercase tracking-[0.1em] whitespace-nowrap z-10 origin-center">
